...
var _get = function t(e, i, n) {
  ...
  var t = document,
    ...
    return "string" == typeof t;
      ...
      u = /<.+>/,
      c = /^\w+$/;function p(e, i) {
    i = i || t;var n = d.test(e) ? i.getElementsByClassName(e.slice(1)) : c.test(e) ? i.getElementsByTagName(e) : i.querySelectorAll(e);return n;
  }var v;function f(e) {
    if (!v) {
      var i = (v = t.implementation.createHTMLDocument(null)).createElement("base");i.href = t.location.href, v.head.appendChild(i);
    }return v.body.innerHTML = e, v.body.childNodes;
  }function m(e) {
    "loading" !== t.readyState ? e() : t.addEventListener("DOMContentLoaded", e);
  }function g(i, n) {
    if (!i) return this;if (i.cash && i !== e) return i;var s,
        o = i,
        a = 0;if (l(i)) o = h.test(i) ? t.getElementById(i.slice(1)) : u.test(i) ? f(i) : p(i, n);else if (r(i)) return m(i), this;if (!o) return this;if (o.nodeType || o === e) this[0] = o, this.length = 1;else for (s = this.length = o.length; a < s; a++) {
      this[a] = o[a];
    }return this;
  }function _(t, e) {
    return new g(t, e);
  }var y = _.fn = _.prototype = g.prototype = { cash: !0, length: 0, push: o, splice: i.splice, map: i.map, init: g };Object.defineProperty(y, "constructor", { value: _ }), _.parseHTML = f, _.noop = a, _.isFunction = r, _.isString = l, _.extend = y.extend = function (t) {
    t = t || {};var e = n.call(arguments),
        i = e.length,
        s = 1;for (1 === e.length && (t = this, s = 0); s < i; s++) {
      if (e[s]) for (var o in e[s]) {
    ...
    var i = M(t);return void 0 === i[e] && (i[e] = t.dataset ? t.dataset[e] : _(t).attr("data-" + e)), i[e];
  }y.extend({ data: function data(t, e) {
      ...
      return this.each(function (e) {
        return function (t, e) {
          var i = M(t);i ? delete i[e] : t.dataset ? delete t.dataset[e] : _(t).removeAttr("data-" + name);
        }(e, t);
      });
    } });var T = /\S+/g;function O(t) {
    ...
    t.classList ? t.classList.remove(e) : t.className = t.className.replace(e, "");
      ...
      var e = O(t);return e ? this.each(function (t) {
        var i = " " + t.className + " ";k(e, function (e) {
          D(t, e, i);
        });
      }) : this;
      ...
      var e = !1,
          i = O(t);return i && i.length && this.each(function (t) {
        return !(e = $(t, i[0]));
      }), e;
      ...
      if (!arguments.length) return this.attr("class", "");var e = O(t);return e ? this.each(function (t) {
        k(e, function (e) {
          B(t, e);
        });
      }) : this;
      ...
      if (void 0 !== e) return this[e ? "addClass" : "removeClass"](t);var i = O(t);return i ? this.each(function (t) {
        var e = " " + t.className + " ";k(i, function (i) {
          $(t, i) ? B(t, i) : D(t, i, e);
        });
      }) : this;
      ...
      if (!t) return this;var e = r(t) ? t : w(t);return _(s.call(this, function (i) {
        return e(i, t);
      }));
      ...
      var e = t ? _(t)[0] : this[0],
          i = t ? this : _(e).parent().children();return n.call(i).indexOf(e);
    }, last: function last() {
      return this.eq(-1);
    } });var I = function () {
    var t = /(?:^\w|[A-Z]|\b\w)/g,
    ...
    var t = {},
        ...
        n = i.style;return function (e) {
      if (e = I(e), t[e]) return t[e];var i = e.charAt(0).toUpperCase() + e.slice(1),
          s = (e + " " + ["webkit", "moz", "ms", "o"].join(i + " ") + i).split(" ");return k(s, function (i) {
        if (i in n) return t[i] = e = t[e] = i, !1;
      }), t[e];
    };
  }();_.prefixedProp = S, _.camelCase = I, y.extend({ css: function css(t, i) {
      if (l(t)) return t = S(t), arguments.length > 1 ? this.each(function (e) {
        return e.style[t] = i;
      }) : e.getComputedStyle(this[0])[t];for (var n in t) {
        this.css(n, t[n]);
      }return this;
    } });function A(t, i) {
    return parseInt(e.getComputedStyle(t[0], null)[i], 10) || 0;
  }k(["Width", "Height"], function (t) {
    var e = t.toLowerCase();y[e] = function () {
    ...
    var n,
        s = L(t, "_cashEvents"),
        o = s && s[e];o && (i ? (t.removeEventListener(e, i), (n = o.indexOf(i)) >= 0 && o.splice(n, 1)) : (k(o, function (i) {
      t.removeEventListener(e, i);
    }), o = []));
  }y.extend({ off: function off(t, e) {
      ...
      }return r(e) && (i = e, e = null), "ready" === t ? (m(i), this) : (e && (s = i, i = function i(t) {
        for (var i = t.target; !b(i, e);) {
          if (i === this || null === i) return i = !1;i = i.parentNode;
        }i && s.call(i, t);
      }), this.each(function (e) {
        var _s = i;n && (_s = function s() {
          i.apply(this, arguments), R(e, t, _s);
        }), function (t, e, i) {
          var n = L(t, "_cashEvents") || x(t, "_cashEvents", {});n[e] = n[e] || [], n[e].push(i), t.addEventListener(e, i);
        }(e, t, _s);
      }));
    ...
    var n = l(e);n || !e.length ? k(t, n ? function (t) {
      ...
      var e = this;return _(t).each(function (t, i) {
        var n = t.parentNode,
    ...
    } });var j = t.documentElement;return y.extend({ position: function position() {
      var t = this[0];return { left: t.offsetLeft, top: t.offsetTop };
    }, offset: function offset() {
      var t = this[0].getBoundingClientRect();return { top: t.top + e.pageYOffset - j.clientTop, left: t.left + e.pageXOffset - j.clientLeft };
    }, offsetParent: function offsetParent() {
      return _(this[0].offsetParent);
    } }), y.extend({ children: function children(t) {
      ...
      if (!t) return !1;var e = !1,
          i = w(t);return this.each(function (n) {
        return !(e = i(n, t));
      }), e;
    }, find: function find(t) {
      if (!t || t.nodeType) return _(t && this.has(t).length ? t : null);var e = [];return this.each(function (i) {
        o.apply(e, p(t, i));
      }), C(e);
    }, has: function has(t) {
      ...
      if (!t) return this;var e = w(t);return this.filter(function (i) {
        return !e(i, t);
      });
  ...
  function t(e, i, n) {
    _classCallCheck(this, t), i instanceof Element || console.error(Error(i + " is not an HTML Element"));var s = e.getInstance(i);s && s.destroy(), this.el = i, this.$el = cash(i);
      ...
      var n = null;if (e instanceof Element) n = new t(e, i);else if (e.jquery || e instanceof NodeList) {
  ...
  function t(t) {
    ...
    t = t.points;for (var e, i = 0, n = 0; n < t.numberOfItems; n++) {
      var s = t.getItem(n);0 < n && (i += v(e, s)), e = s;
    }return i;
  }function m(t) {
    if (t.getTotalLength) return t.getTotalLength();switch (t.tagName.toLowerCase()) {case "circle":
        ...
        return v({ x: t.getAttribute("x1"), y: t.getAttribute("y1") }, { x: t.getAttribute("x2"), y: t.getAttribute("y2") });case "polyline":
        return f(t);case "polygon":
    ...
    var i,
        n = /-?\d*\.?\d+/g;if (i = O.pth(t) ? t.totalLength : t, O.col(i)) {
      if (O.rgb(i)) {
    ...
    } else s = (s = l(i)) ? i.substr(0, i.length - s.length) : i, i = e && !/\s/g.test(i) ? s + e : s;return { original: i += "", numbers: i.match(n) ? i.match(n).map(Number) : [0], strings: O.str(t) || e ? i.split(n) : [] };
  }function y(t) {
    return e(t = t ? i(O.arr(t) ? t.map(n) : n(t)) : [], function (t, e, i) {
      return i.indexOf(t) === e;
    });
  }function k(t, e) {
    var i = o(e);if (O.arr(t)) {
      var s = t.length;2 !== s || O.obj(t[0]) ? O.fnc(e.duration) || (i.duration = e.duration / s) : t = { value: t };
    }return n(t).map(function (t, i) {
      return i = i ? 0 : e.delay, t = O.obj(t) && !O.pth(t) ? t : { value: t }, O.und(t.delay) && (t.delay = i), t;
    }).map(function (t) {
      return r(t, i);
    });
  }function b(t, e) {
    var i;return t.tweens.map(function (n) {
      var s = (n = function (t, e) {
        var i,
            n = {};for (i in t) {
          var s = h(t[i], e);O.arr(s) && (s = s.map(function (t) {
            return h(t, e);
          ...
          a = O.arr(s) ? s[0] : a,
          r = p(O.arr(s) ? s[1] : s, a),
          o = l(r) || l(a) || l(o);return n.from = _(a, o), n.to = _(r, o), n.start = i ? i.end : t.offset, n.end = n.start + n.delay + n.duration, n.easing = function (t) {
    ...
    var n,
        ...
        o = a(L, t),
        l = function (t) {
      var e = y(t);return e.map(function (t, i) {
        return { target: t, id: i, total: e.length };
      });
    }(t.targets),
        h = [],
        d = r(s, o);for (n in t) {
      d.hasOwnProperty(n) || "targets" === n || h.push({ name: n, offset: d.offset, tweens: k(t[n], o) });
    }c = h, t = e(i(l.map(function (t) {
      return c.map(function (e) {
        var i = u(t.target, e.name);if (i) {
          var n = b(e, t);e = { type: i, property: e.name, animatable: t, tweens: n, duration: n[n.length - 1].end, delay: n[0].delay };
        } else e = void 0;return e;
      });
    })), function (t) {
      return !O.und(t);
    });var c;return r(s, { children: [], animatables: l, animations: t, duration: w("duration", t, s, o), delay: w("delay", t, s, o) });
  }function E(t) {
    function i() {
      ...
      for (var i = 0, n = {}, s = v.animations, o = s.length; i < o;) {
        var a = s[i],
            ...
            l = a.tweens,
            h = l.length - 1,
            u = l[h];h && (u = e(l, function (e) {
          return t < e.end;
        })[0] || u);for (var l = Math.min(Math.max(t - u.start - u.delay, 0), u.duration) / u.duration, c = isNaN(l) ? 1 : u.easing(l, u.elasticity), l = u.to.strings, p = u.round, h = [], f = void 0, f = u.to.numbers.length, m = 0; m < f; m++) {
          var _ = void 0,
              _ = u.to.numbers[m],
              y = u.from.numbers[m],
              _ = u.isPath ? g(u.value, c * _) : y + c * (_ - y);p && (u.isColor && 2 < m || (_ = Math.round(_ * p) / p)), h.push(_);
        }if (u = l.length) for (f = l[0], c = 0; c < u; c++) {
          p = l[c + 1], m = h[c], isNaN(m) || (f = p ? f + (m + p) : f + (m + " "));
        } else f = h[0];B[a.type](r.target, a.property, f, n, r.id), a.currentValue = f, i++;
      }if (i = Object.keys(n).length) for (s = 0; s < i; s++) {
        M || (M = d(document.body, "transform") ? "transform" : "-webkit-transform"), v.animatables[s].target.style[M] = n[s].join(" ");
      ...
      x = { update: void 0, begin: void 0, run: void 0, complete: void 0, loop: 1, direction: "normal", autoplay: !0, offset: 0 },
    ...
    var e = m(t);return t.setAttribute("stroke-dasharray", e), e;
  }, E.bezier = $, E.easings = D, E.timeline = function (t) {
    var e = E(t);return e.pause(), e.duration = 0, e.add = function (i) {
      return e.children.forEach(function (t) {
        t.began = !0, t.completed = !0;
      }), n(i).forEach(function (i) {
        var n = r(i, a(L, t || {}));n.targets = n.targets || t.targets, i = e.duration;var s = n.offset;n.autoplay = !1, n.direction = e.direction, n.offset = O.und(s) ? i : p(s, i), e.began = !0, e.completed = !0, e.seek(n.offset), (n = E(n)).began = !0, n.completed = !0, n.duration > i && (e.duration = n.duration), e.children.push(n);
  ...
  var i = { accordion: !0, onOpenStart: void 0, onOpenEnd: void 0, onCloseStart: void 0, onCloseEnd: void 0, inDuration: 300, outDuration: 300 },
      n = function (n) {
    _inherits(s, Component);function s(e, i) {
      _classCallCheck(this, s);var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));n.el.M_Collapsible = n, n.options = t.extend({}, s.defaults, i), n._setupEventHandlers();var o = n.$el.children("li.active").children(".collapsible-body");return n.options.accordion ? o.first().css("display", "block") : o.css("display", "block"), n;
    }return _createClass(s, [{ key: "destroy", value: function value() {
  ...
  "use strict";
  var i = { alignment: "left", constrainWidth: !0, coverTrigger: !0, closeOnClick: !0, hover: !1, inDuration: 150, outDuration: 250, onOpenStart: null, onOpenEnd: null, onCloseStart: null, onCloseEnd: null },
      n = function (n) {
    _inherits(s, Component);function s(e, i) {
      _classCallCheck(this, s);var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));return n.el.M_Dropdown = n, s._dropdowns.push(n), n.id = M.getIdFromTrigger(e), n.dropdownEl = document.getElementById(n.id), n.$dropdownEl = t(n.dropdownEl), n.options = t.extend({}, s.defaults, i), n.isOpen = !1, n.focusedIndex = -1, n.filterQuery = [], n.$el.after(n.dropdownEl), n._makeDropdownFocusable(), n._resetFilterQueryBound = n._resetFilterQuery.bind(n), n._handleDocumentClickBound = n._handleDocumentClick.bind(n), n._handleDropdownKeydownBound = n._handleDropdownKeydown.bind(n), n._handleTriggerKeydownBound = n._handleTriggerKeydown.bind(n), n._setupEventHandlers(), n;
        ...
        var i = this,
            n = t(e.target);this.options.closeOnClick && n.closest(".dropdown-content").length ? setTimeout(function () {
          i.close();
        ...
        if (e.which === M.keys.TAB) e.preventDefault(), this.close();else if (e.which !== M.keys.ARROW_DOWN && e.which !== M.keys.ARROW_UP || !this.isOpen) {
          ...
          e.preventDefault();var s = e.which === M.keys.ARROW_DOWN ? 1 : -1;this.focusedIndex = Math.max(Math.min(this.focusedIndex + s, this.dropdownEl.children.length - 1), 0), this._focusFocusedItem();
        }var o = String.fromCharCode(e.which).toLowerCase();if (o && -1 === [9, 13, 27, 38, 40].indexOf(e.which)) {
          this.filterQuery.push(o);var a = this.filterQuery.join(""),
              r = t(this.dropdownEl).find("li").filter(function (e) {
            return 0 === t(e).text().toLowerCase().indexOf(a);
          })[0];r && (this.focusedIndex = t(r).index(), this._focusFocusedItem());
        ...
        this.el.offsetParent.getBoundingClientRect();var t = { left: this.el.offsetLeft, top: this.el.offsetTop, width: this.el.offsetWidth, height: this.el.offsetHeight },
            ...
            d = "top",
            u = this.options.alignment;if (a += this.options.coverTrigger ? 0 : e.height, h.top || (h.bottom ? d = "bottom" : h.spaceOnTop > h.spaceOnBottom ? (d = "bottom", n += h.spaceOnTop, a -= h.spaceOnTop) : n += h.spaceOnBottom), !h[u]) {
          var c = "left" === u ? "right" : "left";h[c] ? u = c : h.spaceOnLeft > h.spaceOnRight ? (u = "right", s += h.spaceOnLeft, o -= h.spaceOnLeft) : (u = "left", s += h.spaceOnRight);
        }return "bottom" === d && (a = a - i.height + (this.options.coverTrigger ? e.height : 0)), "right" === u && (o = o - i.width + e.width), { x: o, y: a, verticalAlignment: d, horizontalAlignment: u, height: n, width: s };
      } }, { key: "_animateIn", value: function value(t) {
        var i = this;this.dropdownEl.style.left = t.x + "px", this.dropdownEl.style.top = t.y + "px", this.dropdownEl.style.height = t.height + "px", this.dropdownEl.style.width = t.width + "px", this.dropdownEl.style.transformOrigin = ("left" === t.horizontalAlignment ? "0" : "100%") + " " + ("top" === t.verticalAlignment ? "0" : "100%"), e.remove(this.dropdownEl), e({ targets: this.dropdownEl, opacity: { value: [0, 1], easing: "easeOutQuad" }, scaleX: [.3, 1], scaleY: [.3, 1], duration: this.options.inDuration, easing: "easeOutQuint", complete: function complete(t) {
  ...
  var i = { opacity: .5, inDuration: 250, outDuration: 250, onOpenStart: null, onOpenEnd: null, onCloseStart: null, onCloseEnd: null, dismissible: !0, startingTop: "4%", endingTop: "10%" },
      n = function (n) {
    _inherits(s, Component);function s(e, i) {
      _classCallCheck(this, s);var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));return n.el.M_Modal = n, n.options = t.extend({}, s.defaults, i), n.isOpen = !1, n.id = n.$el.attr("id"), n._openingTrigger = void 0, n.$overlay = t('<div class="modal-overlay"></div>'), s._increment++, s._count++, n.$overlay[0].style.zIndex = 1e3 + 2 * s._increment, n.el.style.zIndex = 1e3 + 2 * s._increment + 1, n._setupEventHandlers(), n;
    }return _createClass(s, [{ key: "destroy", value: function value() {
    ...
    _inherits(s, Component);function s(e, i) {
      _classCallCheck(this, s);var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));return n.el.M_Materialbox = n, n.options = t.extend({}, s.defaults, i), n.overlayActive = !1, n.doneAnimating = !0, n.placeholder = t("<div></div>").addClass("material-placeholder"), n.originalWidth = 0, n.originalHeight = 0, n.originInlineStyles = n.$el.attr("style"), n.caption = n.el.getAttribute("data-caption") || "", n.$el.before(n.placeholder), n.placeholder.append(n.$el), n._setupEventHandlers(), n;
        ...
        var t = this,
            ...
            t.placeholder.css({ height: "", width: "", position: "", top: "", left: "" }), t.$el.removeAttr("style"), t.$el.attr("style", t.originInlineStyles), t.$el.removeClass("active"), t.doneAnimating = !0, t.ancestorsChanged.length && t.ancestorsChanged.css("overflow", ""), "function" == typeof t.options.onCloseEnd && t.options.onCloseEnd.call(t, t.el);
          } };e(i);
        ...
        }), this.$el.before(this.$overlay);var n = this.$overlay[0].getBoundingClientRect();this.$overlay.css({ width: this.windowWidth + "px", height: this.windowHeight + "px", left: -1 * n.left + "px", top: -1 * n.top + "px" }), e.remove(this.el), e.remove(this.$overlay[0]), "" !== this.caption && e.remove(this.$photoCaption[0]), e({ targets: this.$overlay[0], opacity: 1, duration: this.options.inDuration, easing: "easeOutQuad" }), "" !== this.caption && (this.$photoCaption = t('<div class="materialbox-caption"></div>'), this.$photoCaption.text(this.caption), t("body").append(this.$photoCaption), this.$photoCaption.css({ display: "inline" }), e({ targets: this.$photoCaption[0], opacity: 1, duration: this.options.inDuration, easing: "easeOutQuad" }));var s = 0,
  ...
  var e = { responsiveThreshold: 0 },
      i = function (i) {
    _inherits(n, Component);function n(e, i) {
      _classCallCheck(this, n);var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));return s.el.M_Parallax = s, s.options = t.extend({}, n.defaults, i), s.$img = s.$el.find("img").first(), s._enabled = window.innerWidth > s.options.responsiveThreshold, s._updateParallax(), s._setupEventHandlers(), s._setupStyles(), n._parallaxes.push(s), s;
    }return _createClass(n, [{ key: "destroy", value: function value() {
  ...
  var i = { duration: 300, onShow: null, swipeable: !1, responsiveThreshold: 1 / 0 },
    ...
    _inherits(s, Component);function s(e, i) {
      _classCallCheck(this, s);var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));return n.el.M_Tabs = n, n.options = t.extend({}, s.defaults, i), n.$tabLinks = n.$el.children("li.tab").children("a"), n.index = 0, n._setTabsAndTabWidth(), n._setupActiveTabLink(), n._createIndicator(), n.options.swipeable ? n._setupSwipeableTabs() : n._setupNormalTabs(), n._setupEventHandlers(), n;
        ...
        });var n = t('<div class="tabs-content carousel carousel-slider"></div>');i.first().before(n), n.append(i), i[0].style.display = "", this._tabsCarousel = M.Carousel.init(n[0], { fullWidth: !0, noWrap: !0, onCycleTo: function onCycleTo(i) {
  ...
  var i = { exitDelay: 200, enterDelay: 0, html: null, margin: 5, inDuration: 250, outDuration: 200, position: "bottom", transitionMovement: 10 },
      n = function (n) {
    _inherits(s, Component);function s(e, i) {
      _classCallCheck(this, s);var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));return n.el.M_Tooltip = n, n.options = t.extend({}, s.defaults, i), n.isOpen = !1, n.isHovered = !1, n._appendTooltipEl(), n._setupEventHandlers(), n;
    }return _createClass(s, [{ key: "destroy", value: function value() {
        ...
        var t = {},
            ...
            i = this.$el[0].getAttribute("data-position");return e && (t.html = e), i && (t.position = i), t;
      } }], [{ key: "init", value: function value(t, e) {
        return _get(s.__proto__ || Object.getPrototypeOf(s), "init", this).call(this, this, t, e);
      } }, { key: "getInstance", value: function value(t) {
  ...
  var e = e || {},
    ...
    var e = "";for (var i in t) {
      ...
      o = { touches: 0, allowEvent: function allowEvent(t) {
      var e = !0;return "touchstart" === t.type ? o.touches += 1 : "touchend" === t.type || "touchcancel" === t.type ? setTimeout(function () {
    ...
    var i = function (t) {
      if (!1 === o.allowEvent(t)) return null;for (var e = null, i = t.target || t.srcElement; null !== i.parentNode;) {
        if (!(i instanceof SVGElement) && -1 !== i.className.indexOf("waves-effect")) {
          e = i;break;
        }i = i.parentNode;
      }return e;
    }(e);null !== i && (s.show(e, i), "ontouchstart" in t && (i.addEventListener("touchend", s.hide, !1), i.addEventListener("touchcancel", s.hide, !1)), i.addEventListener("mouseup", s.hide, !1), i.addEventListener("mouseleave", s.hide, !1), i.addEventListener("dragend", s.hide, !1));
  ...
  var i = { edge: "left", draggable: !0, inDuration: 250, outDuration: 200, onOpenStart: null, onOpenEnd: null, onCloseStart: null, onCloseEnd: null },
    ...
    _inherits(s, Component);function s(e, i) {
      _classCallCheck(this, s);var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));return n.el.M_Sidenav = n, n.id = n.$el.attr("id"), n.options = t.extend({}, s.defaults, i), n.isOpen = !1, n.isFixed = n.el.classList.contains("sidenav-fixed"), n.isDragged = !1, n._createOverlay(), n._createDragTarget(), n._setupEventHandlers(), n._setupClasses(), n._setupFixed(), s._sidenavs.push(n), n;
        ...
        var i = t.targetTouches[0].clientX;this.isDragged = !0, this._startingXpos = i, this._xPos = this._startingXpos, this._time = Date.now(), this._width = this.el.getBoundingClientRect().width, this._overlay.style.display = "block", e.remove(this.el), e.remove(this._overlay);
      } }, { key: "_dragMoveUpdate", value: function value(t) {
        var e = t.targetTouches[0].clientX;this.deltaX = Math.abs(this._xPos - e), this._xPos = e, this.velocityX = this.deltaX / (Date.now() - this._time), this._time = Date.now();
        ...
        if (!1 !== this.isOpen) if (this.isOpen = !1, "function" == typeof this.options.onCloseStart && this.options.onCloseStart.call(this, this.el), this.isFixed && window.innerWidth > 992) {
  ...
  var e = { data: {}, limit: 1 / 0, onAutocomplete: null, minLength: 1, sortFunction: function sortFunction(t, e, i) {
    ...
    _inherits(n, Component);function n(e, i) {
      _classCallCheck(this, n);var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));return s.el.M_Autocomplete = s, s.options = t.extend({}, n.defaults, i), s.isOpen = !1, s.count = 0, s.activeIndex = -1, s.oldVal, s.$inputField = s.$el.closest(".input-field"), s.$active = t(), s._setupDropdown(), s._setupEventHandlers(), s;
        ...
        "keyup" === t.type && (n._keydown = !1), this.count = 0;var e = this.el.value.toLowerCase();13 !== t.keyCode && 38 !== t.keyCode && 40 !== t.keyCode && (this.oldVal !== e && (this._removeAutocomplete(), e.length >= this.options.minLength && (this.isOpen = !0, this._renderDropdown(this.options.data, e))), this.oldVal = e);
      ...
      } }, { key: "_removeAutocomplete", value: function value() {
        t(this.container).empty(), this._resetCurrentElement(), this.oldVal = null, this.isOpen = !1;
      } }, { key: "selectOption", value: function value(t) {
        var e = t.text().trim();this.el.value = e, this.$el.trigger("change"), this._removeAutocomplete(), "function" == typeof this.options.onAutocomplete && this.options.onAutocomplete.call(this, e);
      } }, { key: "_renderDropdown", value: function value(e, i) {
        var n = this;this._removeAutocomplete();var s = [];for (var o in e) {
  ...
  M.updateTextFields = function () {
    ...
    e instanceof Element && (e = t(e));var i = t(".hiddendiv").first();i.length || (i = t('<div class="hiddendiv common"></div>'), t("body").append(i));var n = e.css("font-family"),
        s = e.css("font-size"),
        o = e.css("line-height"),
        a = e.css("padding-top"),
        r = e.css("padding-right"),
        l = e.css("padding-bottom"),
        h = e.css("padding-left");s && i.css("font-size", s), n && i.css("font-family", n), o && i.css("line-height", o), a && i.css("padding-top", a), r && i.css("padding-right", r), l && i.css("padding-bottom", l), h && i.css("padding-left", h), e.data("original-height") || e.data("original-height", e.height()), "off" === e.attr("wrap") && i.css("overflow-wrap", "normal").css("white-space", "pre"), i.text(e[0].value + "\n");var d = i.html().replace(/\n/g, "<br>");i.html(d), "hidden" !== e.css("display") ? i.css("width", e.width() + "px") : i.css("width", t(window).width() / 2 + "px"), e.data("original-height") <= i.innerHeight() ? e.css("height", i.innerHeight() + "px") : e[0].value.length < e.data("previous-length") && e.css("height", e.data("original-height") + "px"), e.data("previous-length", e[0].value.length);
  }, t(document).ready(function () {
    var e = "input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], textarea";t(document).on("change", e, function () {
      ...
      if (e.which !== M.keys.TAB) ;else {
        t(this).addClass("tabbed");t(this).one("blur", function (e) {
          t(this).removeClass("tabbed");
        });
      }
    });var i = ".materialize-textarea";t(i).each(function () {
  ...
  var i = { indicators: !0, height: 400, duration: 500, interval: 6e3 },
      n = function (n) {
    _inherits(s, Component);function s(i, n) {
      _classCallCheck(this, s);var o = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, i, n));return o.el.M_Slider = o, o.options = t.extend({}, s.defaults, n), o.$slider = o.$el.find(".slides"), o.$slides = o.$slider.children("li"), o.activeIndex = o.$slider.find(".active").index(), -1 != o.activeIndex && (o.$active = o.$slides.eq(o.activeIndex)), o._setSliderHeight(), o.$slides.find(".caption").each(function (t) {
  ...
  var e = { data: [], placeholder: "", secondaryPlaceholder: "", autocompleteOptions: {}, limit: 1 / 0, onChipAdd: null, onChipSelect: null, onChipDelete: null },
    ...
    }return _createClass(n, [{ key: "getData", value: function value() {
        ...
        n._keydown = !0;var i = t(e.target).closest(".chips"),
          ...
          var o = i[0].M_Chips;if (8 === e.keyCode || 46 === e.keyCode) {
            e.preventDefault();var a = o.chipsData.length;if (o._selectedChip) {
              var r = o._selectedChip.index();o.deleteChip(r), o._selectedChip = null, a = r - 1;
  ...
  var e = { format: "mmm dd, yyyy", parse: null, defaultDate: null, setDefaultDate: !1, disableWeekends: !1, disableDayFn: null, firstDay: 0, minDate: null, maxDate: null, yearRange: 10, minYear: 0, maxYear: 9999, minMonth: void 0, maxMonth: void 0, startRange: null, endRange: null, isRTL: !1, showMonthAfterYear: !1, showDaysInNextAndPreviousMonths: !1, container: null, i18n: { clear: "Clear", today: "Today", done: "Ok", previousMonth: "‹", nextMonth: "›", months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], monthsShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], weekdaysShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], weekdays: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], weekdaysAbbrev: ["S", "M", "T", "W", "T", "F", "S"] }, events: [], onSelect: null, onOpen: null, onClose: null, onDraw: null },
    ...
    _inherits(n, Component);function n(e, i) {
      _classCallCheck(this, n);var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));s.el.M_Datepicker = s, s.options = t.extend({}, n.defaults, i), s.options.minDate && s.options.minDate.setHours(0, 0, 0, 0), s.options.maxDate && s.options.maxDate.setHours(0, 0, 0, 0), s.id = M.guid(), s._setupVariables(), s._insertHTMLIntoDOM(), s._setupModal(), s._setupEventHandlers(), s.options.defaultDate || (s.options.defaultDate = new Date(Date.parse(s.el.value)), s.options.setDefaultDate = !0);var o = s.options.defaultDate;return n._isDate(o) ? s.options.setDefaultDate ? s.setDate(o, !0) : s.gotoDate(o) : s.gotoDate(new Date()), s.isOpen = !1, s;
        ...
        this.clearBtn.innerHTML = this.options.i18n.clear, this.todayBtn.innerHTML = this.options.i18n.today, this.doneBtn.innerHTML = this.options.i18n.done;var t = document.querySelector(this.options.container);this.options.container && t ? this.$modalEl.appendTo(t) : this.$modalEl.insertBefore(this.el);
        ...
        var e = this;if (t = t || this.options.format, !n._isDate(this.date)) return "";return t.split(/(d{1,4}|m{1,4}|y{4}|yy|!.)/g).map(function (t) {
        ...
        if (this.isOpen || t) {
          ...
          }this.calendarEl.innerHTML = a;var h = this.calendarEl.querySelector(".pika-select-year"),
              d = this.calendarEl.querySelector(".pika-select-month");M.Select.init(h, { classes: "select-year" }), M.Select.init(d, { classes: "select-month" }), h.addEventListener("change", this._handleYearChange.bind(this)), d.addEventListener("change", this._handleMonthChange.bind(this)), "function" == typeof this.options.onDraw && this.options.onDraw(this);
        }
      } }, { key: "_setupEventHandlers", value: function value() {
        ...
        var e = this;this.$modalEl = t(n._template), this.modalEl = this.$modalEl[0], this.calendarEl = this.modalEl.querySelector(".pika-single"), this.yearTextEl = this.modalEl.querySelector(".year-text"), this.dateTextEl = this.modalEl.querySelector(".date-text"), this.clearBtn = this.modalEl.querySelector(".datepicker-clear"), this.todayBtn = this.modalEl.querySelector(".datepicker-today"), this.doneBtn = this.modalEl.querySelector(".datepicker-done"), this.formats = { dd: function dd() {
      ...
      } }, { key: "_handleTodayClick", value: function value() {
  ...
  "use strict";
  var e = { dialRadius: 135, outerRadius: 105, innerRadius: 70, tickRadius: 20, duration: 350, container: null, defaultTime: "now", fromnow: 0, doneText: "Ok", clearText: "Clear", cancelText: "Cancel", autoClose: !1, twelveHour: !0, vibrate: !0 },
      i = function (i) {
    _inherits(n, Component);function n(e, i) {
      _classCallCheck(this, n);var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));return s.el.M_Timepicker = s, s.options = t.extend({}, n.defaults, i), s.id = M.guid(), s._insertHTMLIntoDOM(), s._setupModal(), s._setupVariables(), s._setupEventHandlers(), s._clockSetup(), s._pickerSetup(), s;
        ...
        t.preventDefault();var e = this.plate.getBoundingClientRect(),
            i = e.left,
            s = e.top;this.x0 = i + this.options.dialRadius, this.y0 = s + this.options.dialRadius, this.moved = !1;var o = n._Pos(t);this.dx = o.x - this.x0, this.dy = o.y - this.y0, this.setHand(this.dx, this.dy, !1), document.addEventListener("mousemove", this._handleDocumentClickMoveBound), document.addEventListener("touchmove", this._handleDocumentClickMoveBound), document.addEventListener("mouseup", this._handleDocumentClickEndBound), document.addEventListener("touchend", this._handleDocumentClickEndBound);
        ...
        t.preventDefault(), document.removeEventListener("mouseup", this._handleDocumentClickEndBound), document.removeEventListener("touchend", this._handleDocumentClickEndBound);var e = n._Pos(t),
            i = e.x - this.x0,
            s = e.y - this.y0;this.moved && i === this.dx && s === this.dy && this.setHand(i, s), "hours" === this.currentView ? this.showView("minutes", this.options.duration / 2) : this.options.autoClose && (this.minutesView.addClass("timepicker-dial-out"), setTimeout(function () {
          this.done();
        ...
        t('<button class="btn-flat timepicker-clear waves-effect" type="button" tabindex="' + (this.options.twelveHour ? "3" : "1") + '">' + this.options.clearText + "</button>").appendTo(this.footer).on("click", this.clear.bind(this));var e = t('<div class="confirmation-btns"></div>');t('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? "3" : "1") + '">' + this.options.cancelText + "</button>").appendTo(e).on("click", this.close.bind(this)), t('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? "3" : "1") + '">' + this.options.doneText + "</button>").appendTo(e).on("click", this.done.bind(this)), e.appendTo(this.footer);
      ...
      _classCallCheck(this, n);var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));return s.el.M_Carousel = s, s.options = t.extend({}, n.defaults, i), s.hasMultipleSlides = s.$el.find(".carousel-item").length > 1, s.showIndicators = s.options.indicators && s.hasMultipleSlides, s.noWrap = s.options.noWrap || !s.hasMultipleSlides, s.pressed = !1, s.dragged = !1, s.offset = s.target = 0, s.images = [], s.itemWidth = s.$el.find(".carousel-item").first().innerWidth(), s.itemHeight = s.$el.find(".carousel-item").first().innerHeight(), s.dim = 2 * s.itemWidth + s.options.padding || 1, s._autoScrollBound = s._autoScroll.bind(s), s._trackBound = s._track.bind(s), s.options.fullWidth && (s.options.dist = 0, s._setCarouselHeight(), s.showIndicators && s.$el.find(".carousel-fixed-item").addClass("with-indicators")), s.$indicators = t('<ul class="indicators"></ul>'), s.$el.find(".carousel-item").each(function (e, i) {
        ...
        var i = this;this.$el.hasClass("scrolling") || this.el.classList.add("scrolling"), null != this.scrollingTimeout && window.clearTimeout(this.scrollingTimeout), this.scrollingTimeout = window.setTimeout(function () {
          i.$el.removeClass("scrolling");
            ...
            d = void 0,
            u = void 0,
            c = this.center;if (this.offset = "number" == typeof e ? e : this.offset, this.center = Math.floor((this.offset + this.dim / 2) / this.dim), r = -(a = (o = this.offset - this.center * this.dim) < 0 ? 1 : -1) * o * 2 / this.dim, s = this.count >> 1, this.options.fullWidth ? h = "translateX(0)" : (h = "translateX(" + (this.el.clientWidth - this.itemWidth) / 2 + "px) ", h += "translateY(" + (this.el.clientHeight - this.itemHeight) / 2 + "px)"), this.showIndicators) {
          var p = this.center % this.count,
              v = this.$indicators.find(".indicator-item.active");v.index() !== p && (v.removeClass("active"), this.$indicators.find(".indicator-item").eq(p)[0].classList.add("active"));
        }for ((!this.noWrap || this.center >= 0 && this.center < this.count) && (l = this.images[this._wrap(this.center)], t(l).hasClass("active") || (this.$el.find(".carousel-item").removeClass("active"), l.classList.add("active")), l.style[this.xform] = h + " translateX(" + -o / 2 + "px) translateX(" + a * this.options.shift * r * n + "px) translateZ(" + this.options.dist * r + "px)", l.style.zIndex = 0, u = this.options.fullWidth ? 1 : 1 - .2 * r, l.style.opacity = u, l.style.visibility = "visible"), n = 1; n <= s; ++n) {
          this.options.fullWidth ? (d = this.options.dist, u = n === s && o < 0 ? 1 - r : 1) : (d = this.options.dist * (2 * n + r * a), u = 1 - .2 * (2 * n + r * a)), (!this.noWrap || this.center + n < this.count) && ((l = this.images[this._wrap(this.center + n)]).style[this.xform] = h + " translateX(" + (this.options.shift + (this.dim * n - o) / 2) + "px) translateZ(" + d + "px)", l.style.zIndex = -n, l.style.opacity = u, l.style.visibility = "visible"), this.options.fullWidth ? (d = this.options.dist, u = n === s && o > 0 ? 1 - r : 1) : (d = this.options.dist * (2 * n - r * a), u = 1 - .2 * (2 * n - r * a)), (!this.noWrap || this.center - n >= 0) && ((l = this.images[this._wrap(this.center - n)]).style[this.xform] = h + " translateX(" + (-this.options.shift + (-this.dim * n - o) / 2) + "px) translateZ(" + d + "px)", l.style.zIndex = -n, l.style.opacity = u, l.style.visibility = "visible");
  ...
  var e = { onOpen: void 0, onClose: void 0 },
      i = function (i) {
    _inherits(n, Component);function n(e, i) {
      _classCallCheck(this, n);var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));return s.el.M_FeatureDiscovery = s, s.options = t.extend({}, n.defaults, i), s.isOpen = !1, s.$origin = t("#" + s.$el.attr("data-target")), s._setup(), s._calculatePositioning(), s._setupEventHandlers(), s;
    }return _createClass(n, [{ key: "destroy", value: function value() {
        ...
        var e = "fixed" === this.$origin.css("position");if (!e) for (var i = this.$origin.parents(), n = 0; n < i.length && !(e = "fixed" == t(i[n]).css("position")); n++) {}var s = this.$origin.outerWidth(),
            ...
            D = _ / 2 - $ / 2,
            B = g / 2 - O / 2,
            I = {};I.top = v ? y + "px" : "", I.right = p ? l - k - g + "px" : "", I.bottom = f ? h - y - _ + "px" : "", I.left = c ? k + "px" : "", I.position = b, t(this.wrapper).css(I), t(this.contentEl).css({ width: w + "px", height: C + "px", top: E + "px", right: "0px", bottom: "0px", left: x + "px", padding: L + "px", verticalAlign: T }), t(this.waveEl).css({ top: D + "px", left: B + "px", width: O + "px", height: $ + "px" });
      } }, { key: "open", value: function value() {
  ...
  var e = { classes: "" },
      i = function (i) {
    _inherits(n, Component);function n(e, i) {
      _classCallCheck(this, n);var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));return s.el.M_Select = s, s.options = t.extend({}, n.defaults, i), s.isMultiple = s.$el.prop("multiple"), s._keysSelected = {}, s._valueDict = {}, s._setupDropdown(), s._setupEventHandlers(), s;
    }return _createClass(n, [{ key: "destroy", value: function value() {
        ...
        var e = this;this.wrapper = document.createElement("div"), t(this.wrapper).addClass("select-wrapper " + this.options.classes), this.$el.before(t(this.wrapper)), this.wrapper.appendChild(this.el), this.el.disabled && this.wrapper.classList.add("disabled"), this.$selectOptions = this.$el.children("option, optgroup"), this.dropdownOptions = document.createElement("ul"), this.dropdownOptions.id = "select-options-" + M.guid(), t(this.dropdownOptions).addClass("dropdown-content select-dropdown " + (this.isMultiple ? "multiple-select-dropdown" : "")), this.$selectOptions.length && this.$selectOptions.each(function (i) {
          ...
          var n = {};this.isMultiple && (n.closeOnClick = !1), this.dropdown = M.Dropdown.init(this.input, n);
        ...
        if (i) {
          this.isMultiple || e.find("li.selected").removeClass("selected");t(i).addClass("selected");
        }
