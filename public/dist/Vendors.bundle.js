...
"undefined" == typeof jQuery && ( true ? jQuery = $ = __webpack_require__(0) : jQuery = $), function (t) {
    ...
    if (!t.jQuery) {
        ...
        i.isWindow = function (t) {
            ...
            var t,
                ...
                c = arguments.length,
                u = !1;
            for ("boolean" == typeof s && (u = s, s = arguments[l] || {}, l++), "object" != (typeof s === "undefined" ? "undefined" : _typeof(s)) && "function" !== i.type(s) && (s = {}), l === c && (s = this, l--); c > l; l++) {
    ...
    at.prototype = {
        ...
        bindFn: u,
        prefixed: k
    }), ( false ? "undefined" : _typeof(__webpack_require__(6))) == ut && __webpack_require__(7) ? !(__WEBPACK_AMD_DEFINE_RESULT__ = (function () {
        return ot;
     ...
     true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_FACTORY__ = (t),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity, Materialize.Vel = Vel || Velocity, function (t) {
    ...
    Materialize.fadeInImage = function (e) {
        ...
        if ("string" == typeof e) i = t(e);else {
            if ("object" != (typeof e === "undefined" ? "undefined" : _typeof(e))) return;
            i = e;
        }
        i.css({
            opacity: 0
    ...
    o.DEFAULTS = {
        ...
        return this.each(function () {
            ...
            if (a) "function" == typeof a[e] && a[e].apply(a, i);else {
                var r = t.extend({}, o.DEFAULTS, n.data(), "object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) && e);
    ...
    t.fn.tapTarget = function (i) {
        if (e[i] || "object" == (typeof i === "undefined" ? "undefined" : _typeof(i))) return e.init.apply(this, arguments);
